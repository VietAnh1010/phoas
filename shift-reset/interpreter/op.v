...
Fixpoint equal_val (v1 v2 : val) : except exn bool :=
  ...
  | VExn l1 v1', VExn l2 v2' => if ident_eqb l1 l2 then equal_val v1' v2' else pure false
  | VEff l1 v1', VEff l2 v2' => if ident_eqb l1 l2 then equal_val v1' v2' else pure false
